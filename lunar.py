...
from utils.functions import soft_update,get_exploration_rate
...
env = RecordVideo(env, video_folder="./save_videos_lunar_dueling_noise_doubleQ", episode_trigger=trigger, disable_logger=True)

#创建Tensorboard记录器
from torch.utils.tensorboard import SummaryWriter 
writer = SummaryWriter(log_dir='./logs/lunar_dueling_noise_doubleQ_dqn')
