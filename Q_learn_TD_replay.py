#本文使用Q-learning算法，基于Q-table进行学习，并使用经验回放技巧，先随机探索，然后当经验池足够大时，开始使用经验池中的数据进行训练
...
for episode in range(20000):
    ...
    while not done:
        ...
        for _ in range(20):
            ...
            neg_grad = record_replay[2] + discount_rate*np.max(Q_table[record_replay[3],:])*(1-record_replay[4]) -  Q_table[s_t,a_t]
